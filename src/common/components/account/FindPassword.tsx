...
export default function FindPassword() {
    ...
    function sendEmail(){
        setLoading(true)
        axios.post( `${process.env.NEXT_PUBLIC_DB_URL}/reset-password`, 
        { 
         _id: email, 
         }, 
  ...
  return (
    <div className='max-w-[428px] py-[60px] h-full px-[20px] w-full mx-auto mt-[56px]'>
        <ToastContainer/>
        {loading&&<div className="modal-background flex justify-center items-center">
        ...
        <div className='mb-[16px]'>
            ...
            }} type="email" className=' outline-none w-full rounded-[10px] bg-gray-200 h-[48px] border border-gray-400 px-[12px] focus:bg-gray-100 focus:border-gray-700 focus:border-[2px] focus:outline-none focus:text-gray-700 appearance-none' placeholder='이메일을 입력해주세요.' />
        </div>
        <button onClick={()=>{
            sendEmail()

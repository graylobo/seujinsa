...
export default function Main() {
  ...
  return (
    <main className=" pb-[200px] h-[1000px]  absolute left-0 w-full flex min-w-[1000px] ">
      <ToastContainer />
      <div className="cutton"></div>
      <video id="video" src="./backvideo.mp4" autoPlay loop muted></video>
      <div className=" h-[600px] absolute left-[100px] border-[1px] rounded-[5px] border-gray-400 bg-white opacity-[0.8] mt-[30px]">

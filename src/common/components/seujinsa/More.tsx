...
export default function More() {
  ...
  return (
    <div className="p-[30px] w-full max-w-[700px] mx-auto mt-[56px] text-center">
      <Link href={"/seujinsa/left-control"}>
        <p className="cursor-pointer p-2.5 border-b border-gray-60">왼손생산</p>
      </Link>
      <Link href={"/seujinsa/build-alert"}>
        <p className="cursor-pointer p-2.5 border-b border-gray-60">빌드알리미</p>
      </Link>
      <Link href={"/seujinsa/tier/standard"}>
        <p className="cursor-pointer p-2.5 border-b border-gray-60">티어표</p>
      </Link>
      <Link href={"/seujinsa/univ"}>
